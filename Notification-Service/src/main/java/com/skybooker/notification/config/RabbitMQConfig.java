...
public class RabbitMQConfig {
    ...
    public static final String PASSWORD_RESET_OTP_QUEUE = "notification.password.reset.otp";
    ...
    public static final String PASSWORD_RESET_OTP_KEY = "password.reset.otp";
    ...
    @Bean public Queue passwordResetOtpQueue()  { return QueueBuilder.durable(PASSWORD_RESET_OTP_QUEUE).build(); }
    ...
    @Bean public Binding passwordResetOtpBinding() { return BindingBuilder.bind(passwordResetOtpQueue()).to(skybookerExchange()).with(PASSWORD_RESET_OTP_KEY); }
